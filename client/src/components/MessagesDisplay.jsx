        ...
        {messagesWithoutDupes.map((message, index) => (
            <div key={index} dir={message.sender === id ? 'rtl' : 'ltr'} className={"block"}>
                <div className={"max-w-xl sm:max-w-[80%] block"}>
                    {message.file ? (
                        <div>
                            ...
                            <div className="flex items-center">
                                ...
                                (message.sender === id ? 'bg-blue-500 text-white' : 'bg-white dark:bg-neutral-900 text-gray-500')}>
                                    <div className="flex items-center">
                    ...
                    <div className={"p-2 px-4 m-2 rounded-3xl inline-block " + 
                    (message.sender === id ? 'bg-blue-500 text-white' : 'bg-white dark:bg-neutral-800 text-gray-500 dark:text-white')}>
                        <h1 dir="ltr">
                            {message.text}
                        </h1>        
                    </div>}
